package Lesson_48_03042025;

import Lesson_47_02042025.Cat;
...
//                .orElse("");
    ...
    private static void task8_1() {
        List<Lesson_47_02042025.Cat> cats = new ArrayList<>(getListCats());
        cats.add(null);
        System.out.println(cats);
    }

    private static void task8() {
        Lesson_47_02042025.Cat cat = new Lesson_47_02042025.Cat("Bear", 5, "braun");
        Lesson_47_02042025.Cat cat1 = new Lesson_47_02042025.Cat("Python", 7, "green");
        Lesson_47_02042025.Cat cat2 = new Lesson_47_02042025.Cat("Tiger", 3, "yellow");
        Lesson_47_02042025.Cat cat3 = new Lesson_47_02042025.Cat("Panda", 4, "black");

        Lesson_47_02042025.Cat[] cats = {cat, cat1, null, cat2, new Lesson_47_02042025.Cat(null, 10, "red"), cat3};

        // Получить список кошек, имя которых длиннее 4 символов

        // Arrays.stream(cats)- создает поток из элементов массива

        List<Lesson_47_02042025.Cat> longCats = Arrays.stream(cats)
...
//                .filter(c -> Objects.nonNull(c)) // оставить в потоке только не null
    ...
    private static void task7() {
        List<Lesson_47_02042025.Cat> cats = getListCats();
    ...
    private static void task6() {
        ...
        List<String> names1 = cats.stream()
                ...
                .map(Lesson_47_02042025.Cat::getName)
                .collect(Collectors.toList());
...
//        }
    ...
    private static void task3() {
        ...
        Stream<Lesson_47_02042025.Cat> stream = cats.stream()
                .filter(c -> c.getName().length() > 4);

        // Пока не запущен терминальный метод - промежуточные операции не выполняются
        List<Lesson_47_02042025.Cat> longNames = stream.collect(Collectors.toList());
    ...
    private static List<Cat> getListCats() {
        return List.of(
                new Lesson_47_02042025.Cat("Bear", 5, "braun"),
                new Lesson_47_02042025.Cat("Python", 7, "green"),
                new Lesson_47_02042025.Cat("Tiger", 3, "yellow"),
                new Lesson_47_02042025.Cat("Panda", 4, "black")
        );
    }
    ...
    private static void task2() {
        ...
        Stream<Lesson_47_02042025.Cat> catStream = cats.stream()
                .filter(cat -> cat.getWeight() > 4);
